...
* **TinyMCE 本体の読み込み元**: `config/manager.json` や `config/frontend.json` に `"tinymce_script_url"` を追加すると、同梱バンドルの代わりに CDN を利用できます（例: `https://cdn.jsdelivr.net/npm/tinymce@7/tinymce.min.js`).
